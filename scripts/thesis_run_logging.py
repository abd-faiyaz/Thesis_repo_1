...
ARCHIVE_PROFILES: dict[str, ArchiveProfile] = {
    ...
    "pattern_a_combined": ArchiveProfile(
        profile_key="pattern_a_combined",
        model_id="pattern_a_combined",
        display_name="Pattern A (Full Combined Pipeline)",
        env_run_id="PA_RUN_ID",
        checkpoint_rel="artifacts/checkpoints/best.pt",
        export_rel="artifacts/export/pattern_a_combined",
    ...
    "pattern_b_dual_branch": ArchiveProfile(
        profile_key="pattern_b_dual_branch",
        model_id="pattern_b_dual_branch",
        display_name="Pattern B (Dual-Branch Merge)",
        env_run_id="PB_RUN_ID",
        checkpoint_rel="artifacts/checkpoints/best.pt",
        export_rel="artifacts/export/pattern_b_dual_branch",
        metrics_subdir="checkpoints",
        corpus_source="dataset_index_csv",
