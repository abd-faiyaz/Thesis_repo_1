...
/**
 * A4: Pattern B parity — ONNX on device vs PC export parity_samples (tolerance 1e-4).
 */
@RunWith(AndroidJUnit4.class)
public class PatternBParityTest {
  ...
  public void paritySamples_matchPcExport() throws Exception {
    ...
    PatternBOnnxRunner runner = PatternBOnnxRunner.create(context, env);
    try {
      double maxDiff = 0.0;
