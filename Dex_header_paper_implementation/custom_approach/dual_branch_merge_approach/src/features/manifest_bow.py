...
def _quiet_pyaxmlparser():
    """
    pyaxmlparser logs warnings for packed/obfuscated manifests (android: prefix,
    missing namespaces, etc.). Extraction still works; suppress noise during batch runs.
    """
