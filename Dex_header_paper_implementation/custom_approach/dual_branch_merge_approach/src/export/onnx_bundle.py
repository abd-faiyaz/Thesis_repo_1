"""P7/P8: ONNX export bundle and PyTorch vs ONNX parity for Pattern B."""
...
class OnnxInferenceWrapper(nn.Module):
    ...
    def __init__(self, model: DualBranchNet) -> None:
        super().__init__()
        self.model = model
...
def write_parity_samples(
    ...
    *,
    ...
    dataset = DualBranchDataset.from_manifest(manifest_path)
    n = len(dataset)
...
def run_parity_check(
    ...
    *,
    ...
    report: dict[str, Any] = {
        "timestamp": _utc_now(),
        "model_id": manifest.get("model_id", "dual_branch_dex_manifest"),
