...
class PipelineConfig:
    ...
    def model_id(self) -> str:
        return str(self.raw.get("model_id", "broadcast_mldp_hybrid"))

    @property
    def domain(self) -> str:
        return str(self.raw.get("domain", "manifest_mldp_perm_receiver_actions"))
    ...
    def classifier(self) -> dict[str, Any]:
        return self.raw.get("classifier", {})
...
def load_config(config_path: Path | str | None = None) -> PipelineConfig:
    ...
    paths = PathsConfig(
        ...
        export=_resolve_path(
            root,
            paths_raw.get("export", "artifacts/export/broadcast_mldp_hybrid"),
        ),
