...
def get_pipeline_settings(cfg: PipelineConfig) -> PipelineSettings:
    ...
    return PipelineSettings(
        ...
        model_id=str(raw.get("model_id", "linregdroid_permission")),
        domain=str(raw.get("domain", "manifest_permissions")),
...
def build_test_results_payload(
    ...
    *,
    ...
    if "benign" in split_result and "malware" in split_result:
        payload["class_counts"] = {
            "benign": split_result["benign"],
            "malware": split_result["malware"],
        }
    if extra:
